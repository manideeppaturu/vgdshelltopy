...
def xml_file_processing_20200124_25(input_file,output_path):
    column_names=[]
                    ...
                    if main_fields_name_count==1 and len(main_fields_name_cmp_counts)==1:
                        ...
                        if main_fields_name_count!=1:
                            if (main_field_name.getchildren()):
                                ...
                                child_tags=main_field_name.getchildren()
                                child_tag3_fields_name_counts=[]
                                child_tag3_fields_name_cmp_counts=[]
                                xml_row_data_rep3=[]
                                for child_tag in child_tags:
                                    
                                    
                                    if (child_tag.getchildren()):

                                        child_tag3=child_tag.getchildren()
                                        xml_row_data_rep3.append(child_tag3)

                                        for ci in child_tag3:

                                            if row_num ==0:
                                                column_name=str(ci).split(" ")[1][1:-1]
                                                if column_name not in column_names:
                                                    column_names.append(column_name)
                        ...
                        if main_fields_name_count != 1: 
                            if len(xml_row_data_rep3)>=1 :
                                
                                for xml_row_data_r3 in xml_row_data_rep3:                                      
                                    for xml_row_data_r31 in xml_row_data_r3:
                                        xml_row_data.append(xml_row_data_r31)
                                        
                                    delimited_data=xml_row_processing(xml_row_data)
                                    
                                    for xml_row_data_r32 in xml_row_data_r3:
                                        xml_row_data.remove(xml_row_data_r32)
...
xml_file_processing_20200124_25("/home/hduser/Desktop/xml/xml_data3level.xml","/home/hduser/Desktop/xml/")
